    ...
    <div className="projectPageDiv">
      ...
      <div >
        <a href="https://github.com/blair-preston/django_to_do_list">
          <img className="projectDisplayHome" src={backendtodolist} alt="project"></img>
        </a>
      ...
      <div >
        <a href="https://blair-preston.github.io/bouncing-ball/">
          <img className="projectDisplayHome" src={bouncingballs} alt="project"></img>
        </a>
      ...
      <div >
        <a href="https://blair-preston.github.io/alarmclock/">
          <img className="projectDisplayHome" src={alarmclock} alt="project"></img>
        </a>
